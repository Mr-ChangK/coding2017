package com.zhous.hw6.mini_jvm.test;
...
import com.zhous.hw6.mini_jvm.loader.ClassFileLoader;
...
public class ClassFileloaderTest {
	...
	static String path1 = "D:\\java_idea_code\\Homework\\out\\production\\Homework6";
	...
	static {
		...
		String className = "com.zhous.hw6.mini_jvm.test.EmployeeV1";
	...
	public void testConstantPool(){
...

		{
			...
			Assert.assertEquals(3, methodRef.getClassIndex());
		...
		//抽查几个吧
		{
			...
			Assert.assertEquals(1, methodRef.getClassIndex());
